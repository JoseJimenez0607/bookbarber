    ...
    <div style="padding:28px 32px">
      <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:12px;padding:20px;margin-bottom:24px">
        <table style="width:100%;border-collapse:collapse">
          <tr><td style="padding:6px 0;color:#6b7280;font-size:13px;width:110px">Cliente</td><td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${booking.client_name}</td></tr>
          <tr><td style="padding:6px 0;color:#6b7280;font-size:13px">Email</td><td style="padding:6px 0;color:#111827;font-size:13px">${booking.client_email}</td></tr>
          <tr><td style="padding:6px 0;color:#6b7280;font-size:13px">Servicio</td><td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${service.name}</td></tr>
          <tr><td style="padding:6px 0;color:#6b7280;font-size:13px">Fecha</td><td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${dateFormatted}</td></tr>
          <tr><td style="padding:6px 0;color:#6b7280;font-size:13px">Horario</td><td style="padding:6px 0;color:#111827;font-size:13px;font-weight:600">${booking.start_time.slice(0,5)} - ${booking.end_time.slice(0,5)}</td></tr>
          <tr><td style="padding:6px 0;color:#6b7280;font-size:13px">Precio</td><td style="padding:6px 0;color:#16a34a;font-size:15px;font-weight:700">${price}</td></tr>
        </table>
      </div>
...
<body style="margin:0;padding:0;background:#f9fafb;font-family:sans-serif">
  <div style="max-width:560px;margin:32px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1)">
    ...
    <div style="padding:28px 32px">
      ...
      <p style="margin:0 0 24px;color:#6b7280;font-size:14px">Tu reserva esta confirmada. Aqui estan los detalles:</p>
      <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:12px;padding:20px;margin-bottom:24px">
        <table style="width:100%;border-collapse:collapse">
          <tr><td style="padding:7px 0;color:#6b7280;font-size:13px;width:100px">Servicio</td><td style="padding:7px 0;color:#111827;font-size:13px;font-weight:600">${service.name}</td></tr>
          <tr><td style="padding:7px 0;color:#6b7280;font-size:13px">Fecha</td><td style="padding:7px 0;color:#111827;font-size:13px;font-weight:600">${dateFormatted}</td></tr>
          <tr><td style="padding:7px 0;color:#6b7280;font-size:13px">Horario</td><td style="padding:7px 0;color:#111827;font-size:13px;font-weight:600">${booking.start_time.slice(0,5)} - ${booking.end_time.slice(0,5)}</td></tr>
          <tr><td style="padding:7px 0;color:#6b7280;font-size:13px">Precio</td><td style="padding:7px 0;color:#16a34a;font-size:15px;font-weight:700">${price}</td></tr>
        </table>
      </div>
      <div style="text-align:center;margin-bottom:16px">
        <a href="${googleCalUrl}" target="_blank" style="display:inline-block;background:#4285f4;color:#fff;text-decoration:none;padding:12px 24px;border-radius:10px;font-size:14px;font-weight:600">Agregar a Google Calendar</a>
      </div>
